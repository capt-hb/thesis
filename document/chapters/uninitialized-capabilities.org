...
** CHERI-MIPS ISA Extension
   ...
   The code will be easier to follow with the common definitions by hand, which can be found in
   Section 7.3 of the CHERI ISAv7 technical report \parencite{watson2019capability}. 
   # TODO: add that section as an appendix? (generated using sail latex export) 
